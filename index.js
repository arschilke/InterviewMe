...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speechText = "Welcome to Interview Me! You can ask for tips, questions, and full simulations for general, coding, technical, and business job or internship interviews as well as college interviews.";

    return handlerInput.responseBuilder
      .speak(speechText)
      .reprompt(speechText)
      .withSimpleCard('Interview Me', speechText)
      .getResponse();
  },
};
...
const StartJobInterviewIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder
      .speak(speechText)
      // .withSimpleCard('Interview Me', speechText) // Shows break statements
      .getResponse();
  },
}; // Done
...
const StartTechInterviewIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder
      .speak(speechText)
      // .withSimpleCard('Interview Me', speechText) // Shows break statements       .getResponse();
  },
}; // Done
...
const StartBusinessInterviewIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    for(i = 0; i < 2; i++){
      var randIndex = Math.floor(Math.random() * businessQuestions.length);
      var nextQuestion = businessQuestions[randIndex];
      while(checkDuplicates(questions, nextQuestion)){
...
const CancelAndStopIntentHandler = {
  ...
  handle(handlerInput) {
    const speechText = 'Thank you for using interview me, good luck with your interview!';
